...
describe('useIndexerMail', () => {
  ...
  it('should initialize with default values', () => {
    const { result } = renderHook(() => useIndexerMail(networkClient, mockEndpointUrl, mockDev), { wrapper: createWrapper() });
  ...
  it('should cleanup properly on unmount', () => {
    const { unmount } = renderHook(() => useIndexerMail(networkClient, mockEndpointUrl, mockDev), { wrapper: createWrapper() });
